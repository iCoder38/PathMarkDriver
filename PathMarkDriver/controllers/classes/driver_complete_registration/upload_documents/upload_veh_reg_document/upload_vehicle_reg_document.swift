        ...
        didSet {
            ...
            if let language = UserDefaults.standard.string(forKey: str_language_convert) {
                ...
                if (language == "en") {
                    ...
                    view_navigation_title.text = "আপলোড যানবাহন নিবন্ধন"
                }
        ...
        if (cell.txt_vehicle_registration_number.text == "") {
            ...
            if let language = UserDefaults.standard.string(forKey: str_language_convert) {
                ...
                if (language == "en") {
                    ...
                    show_alert(text: "আপনার যানবাহন নিবন্ধন নম্বর লিখুন.")
                }
            ...
            if let language = UserDefaults.standard.string(forKey: str_language_convert) {
                ...
                if (language == "en") {
                    ...
                    show_alert(text: "আপনার যানবাহন রেজিস্ট্রেশন সিটি লিখুন.")
                }
            ...
            if let language = UserDefaults.standard.string(forKey: str_language_convert) {
                ...
                if (language == "en") {
                    ...
                    show_alert(text: "অনুগ্রহ করে আপনার মেয়াদ শেষ হওয়ার তারিখ লিখুন।")
                }
                ...
                if (self.str_user_select_image == "1") {
                    ...
                    if let language = UserDefaults.standard.string(forKey: str_language_convert) {
                        ...
                        if (language == "en") {
                            ...
                            show_alert(text: "আপনার যানবাহন নিবন্ধন আপলোড করুন.")
                        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let language = UserDefaults.standard.string(forKey: str_language_convert) {
            ...
            if (language == "en") {
                ...
                Utils.textFieldUI(textField: cell.txt_vehicle_registration_number,
                                  tfName: cell.txt_vehicle_registration_number.text!,
                                  tfCornerRadius: 12,
                                  tfpadding: 20,
                                  tfBorderWidth: 0,
                                  tfBorderColor: .clear,
                ...
                Utils.textFieldUI(textField: cell.txt_vehicle_registration_state,
                                  tfName: cell.txt_vehicle_registration_state.text!,
                                  tfCornerRadius: 12,
                                  tfpadding: 20,
                                  tfBorderWidth: 0,
                                  tfBorderColor: .clear,
                ...
                Utils.textFieldUI(textField: cell.txt_expiry_date,
                                  tfName: cell.txt_expiry_date.text!,
                                  tfCornerRadius: 12,
                                  tfpadding: 20,
                                  tfBorderWidth: 0,
                                  tfBorderColor: .clear,
                ...
                Utils.textFieldUI(textField: cell.txt_vehicle_registration_number,
                                  ...
                                  tfKeyboardType: .default,
                                  tfBackgroundColor: .white,
                                  tfPlaceholderText: "গাড়ির রেজিস্ট্রেশন নম্বর")
                Utils.textFieldUI(textField: cell.txt_vehicle_registration_state,
                                  tfName: cell.txt_vehicle_registration_state.text!,
                                  tfCornerRadius: 12,
                                  tfpadding: 20,
                                  ...
                                  tfKeyboardType: .default,
                                  tfBackgroundColor: .white,
                                  tfPlaceholderText: "যানবাহন নিবন্ধন সিটি")
                Utils.textFieldUI(textField: cell.txt_expiry_date,
                                  tfName: cell.txt_expiry_date.text!,
                                  tfCornerRadius: 12,
                                  tfpadding: 20,
...
class upload_vehicle_reg_document_table_cell: UITableViewCell {
    ...
    @IBOutlet weak var lbl_registration_City:UILabel! {
        didSet {
            if let language = UserDefaults.standard.string(forKey: str_language_convert) {
                print(language as Any)
                
                if (language == "en") {
                    lbl_registration_City.text = "Registration City"
                } else {
                    lbl_registration_City.text = "রেজিস্ট্রেশন সিটি"
                }
